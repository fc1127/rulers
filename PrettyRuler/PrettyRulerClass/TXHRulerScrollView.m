...
- (void)drawRuler {
    ...
    CGMutablePathRef pathRef1 = CGPathCreateMutable();//最小刻度画的线
    CGMutablePathRef pathRef2 = CGPathCreateMutable();//最长刻度的线
...
//    线路轨迹
    ...
    [self.layer addSublayer:shapeLayer1];//小刻度的线
    [self.layer addSublayer:shapeLayer2];//最长的线
